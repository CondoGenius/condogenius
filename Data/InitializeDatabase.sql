...
VALUES ('Hellen Gurgacz', '083.114.234-12', 2, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Ana Silva', '123.456.789-01', 2, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('João Santos', '987.654.321-09', 2, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Mariana Oliveira', '456.123.789-03', 2, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Pedro Souza', '789.321.456-04', 2, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Julia Almeida', '321.654.987-07', 2, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Lucas Pereira', '654.987.123-05', 2, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Amanda Rodrigues', '987.123.654-06', 2, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Felipe Costa', '456.789.321-08', 2, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Camila Gomes', '123.789.456-02', 2, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Gustavo Martins', '789.456.123-10', 2, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Carlos Silva', '111.222.333-01', 3, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Larissa Oliveira', '444.555.666-02', 3, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Rafaela Souza', '777.888.999-03', 3, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Bruno Santos', '123.234.345-04', 3, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Mário Almeida', '456.567.678-05', 3, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Fernanda Pereira', '789.890.901-06', 3, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Paulo Rodrigues', '234.345.456-07', 3, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Isabella Gomes', '567.678.789-08', 3, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Fábio Costa', '890.901.012-09', 3, NOW(), NOW());

INSERT INTO guest_list (name, cpf, reserve_id, created_at, updated_at)
VALUES ('Thiago Martins', '345.456.567-10', 3, NOW(), NOW());
